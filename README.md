...
For simplicity, all the main code is located in the `word2vec.ipynb` Jupyter notebook.
All the mathematical derivations of computing loss function and gradients are provided in the `math_derivations.pdf` (source TeX file: `math_derivations.tex`).
